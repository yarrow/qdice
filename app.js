...
var $author$project$Dice$maxDie = 6;
var $author$project$Dice$minDie = 1;
var $author$project$Dice$OneDie = function (a) {
	return {$: 'OneDie', a: a};
};
...
var $author$project$Dice$oneDie = function (n) {
	return $author$project$Dice$OneDie(
		A3($elm$core$Basics$clamp, $author$project$Dice$minDie, $author$project$Dice$maxDie, n));
};
var $author$project$Dice$diceRoller = function (n) {
	return A2(
		$elm$random$Random$list,
		n,
		A2(
			$elm$random$Random$map,
			$author$project$Dice$oneDie,
			A2($elm$random$Random$int, $author$project$Dice$minDie, $author$project$Dice$maxDie)));
};
...
var $author$project$Dice$url = function (d) {
